...
#ifndef _TAO_IDL_DATATRANSFERC_W9JEME_H_
#define _TAO_IDL_DATATRANSFERC_W9JEME_H_
...
namespace Datatransfer
{
  ...
  struct  Variables
  {
    ...
    typedef Variables_out _out_type;
    
    ::CORBA::Long var_id;
    ::TAO::String_Manager entity;
    ::CORBA::Long count;
    ::TAO::String_Manager vars;
...
TAO_BEGIN_VERSIONED_NAMESPACE_DECL
 ...
 ::CORBA::Boolean operator<< (TAO_OutputCDR &, const Datatransfer::Variables &);
 ::CORBA::Boolean operator>> (TAO_InputCDR &, Datatransfer::Variables &);
